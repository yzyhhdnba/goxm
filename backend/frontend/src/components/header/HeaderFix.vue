      ...
      <div class="header-top">
        <ul class="header-top-left">
          ...
          <li v-for="(item, index) in leftData" :key="index">
            <a class="entry-title" :href="item.url" target="_blank">
        ...
        <ul class="header-top-right">
          ...
          <li v-for="(item, index) in rightData" :key="index">
            <a class="entry-title entry-right" :href="item.url" target="_blank">
...
export default {
  ...
  methods: {
    ...
    get() {
      axios
        .get("http://101.35.142.191:8081/json/header/headerRight.json")
        .then((e) => {
          this.rightData = e.data.rightData;
          console.log(e.data);
        })
        .catch((error) => {
          console.log(error);
      ...
      axios
        .get("http://101.35.142.191:8081/json/header/headerLeft.json")
        .then((e) => {
          this.leftData = e.data.leftData;
        })
        .catch((error) => {
          console.log(error);
        });
