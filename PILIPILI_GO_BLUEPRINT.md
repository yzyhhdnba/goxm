...
- RabbitMQ 负责点赞、评论、关注、热度更新等异步任务
- Compose 同时拉起 MySQL、Redis、RabbitMQ、Backend、Worker、Frontend
...
- `api + worker + mysql + redis + rabbitmq + frontend` 可一键启动
